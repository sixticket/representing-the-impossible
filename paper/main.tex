...
The complete stimulus JSON, model responses, expected labels, activation array, SAE feature array, and derived figure statistics are available at \url{https://github.com/sixticket/representing-the-impossible}. Model weights and SAE weights are available from their respective Hugging Face repositories.

\bmhead{Code availability}

All scripts required to reproduce activation extraction, SAE encoding, statistical controls, and figures are available at \url{https://github.com/sixticket/representing-the-impossible}.
